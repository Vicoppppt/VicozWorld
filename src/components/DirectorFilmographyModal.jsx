...
import { searchPerson, getDirectorFilmography, getImageUrl } from "../api/tmdb";
import { StarRating } from "./StarRating";

export function DirectorFilmographyModal({ directorName, isOpen, onClose, mediaList, onQuickAddWatchlist }) {
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-8 scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center h-full gap-4 text-zinc-500">
                ...
                <p>Recherche des films de {directorName}...</p>
              </div>
            ) : filmography.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-zinc-500">
                <p className="text-lg">Aucun film trouvé pour ce réalisateur.</p>
              </div>
            ) : (
