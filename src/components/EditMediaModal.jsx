      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-none sm:rounded-2xl shadow-2xl shadow-black/50 overflow-hidden flex flex-col max-h-[100dvh] sm:max-h-[90vh]"
          >
